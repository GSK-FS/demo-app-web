...
from services.json_design_processing import process_images_json_design
...
def process_result():
    img_1_path:str = os.path.join(app.config['UPLOAD_FOLDER'], 'image_1.jpg')
    img_2_path:str = os.path.join(app.config['UPLOAD_FOLDER'], 'image_2.jpg')
    create_processed_folder()
    process_images_json_design(img_1_path, img_2_path)
