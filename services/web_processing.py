...
def process_images_web(design_image_path, developer_image_path):
    ...
    img1 = cv2.resize(img1, (1440, 1024)) # web design
    

    img2 = cv2.imread(developer_image_path)
    #img2 = cv2.resize(img2, (300, 660))
    img2 = cv2.resize(img2, (1440, 746)) # web Develop

    #Crop for responsive Web
    cropped_image1 = img1[0:746, 0:1440] # web Cut (for structural equality)
